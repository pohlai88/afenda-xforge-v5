 ...
 * is itself a finding. (docs/architecture.md §6.2.)
 *
 * Both checkers take text so the fixtures below prove them on planted
...
const GLOBALS = join(DESIGN_SRC, "styles/globals.css");
