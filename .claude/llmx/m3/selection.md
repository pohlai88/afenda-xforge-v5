...
slug: selection · updated: 2026-07-17 · source: m3.material.io
...
![image] Touch used to select 3 list items one after another.
...
![image] List items are tapped to select and unselect them.
...
![image] Long press and drag used to select multiple images in a photo feed.
_**Long press** and **drag** can be used together to select items in batches_
![image] Long press and drag combination used to move cards, but can’t be used to batch select items while in use.
...
![image] Checkboxes being selected and unselected.
