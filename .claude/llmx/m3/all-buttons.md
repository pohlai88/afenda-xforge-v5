...
slug: all-buttons · updated: 2026-07-17 · source: m3.material.io

## §Tab 1

##### There are 10 types of buttons in Material 3.
![image] 10 types of buttons.
_- Button
...
![image] 3 types of hierarchy: high emphasis, medium emphasis, and low emphasis.
...
![image] Newsfeed screen with 3 different types of buttons following the emphasis hierarchy.
_- A filled button for a high-emphasis action

- A text button for a low-emphasis action

- An extended FAB for the highest emphasis action_
![image] Text button to the left of a filled button.
